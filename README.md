...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,722 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,722 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,497 | 🐛 296 | 🌐 Jupyter Notebook | 📅 2026-08-23: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 144,831 | 🐛 419 | 🌐 Python | 📅 2026-08-23: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 63,879 | 🐛 677 | 🌐 Python | 📅 2026-08-23: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,810 | 🐛 68 | 🌐 HTML | 📅 2026-08-23: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,810 | 🐛 68 | 🌐 HTML | 📅 2026-08-23
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,553 | 🐛 225 | 🌐 Python | 📅 2026-08-23: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,206 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,811 | 🐛 542 | 🌐 Python | 📅 2026-08-23
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,278 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-23
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,042 | 🐛 20 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,917 | 🐛 250 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 856 | 🐛 12 | 🌐 Ruby | 📅 2026-08-23

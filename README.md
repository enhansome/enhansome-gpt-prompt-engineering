...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,997 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,997 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,726 | 🐛 295 | 🌐 Jupyter Notebook | 📅 2026-09-03: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,587 | 🐛 444 | 🌐 Python | 📅 2026-09-03: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,661 | 🐛 722 | 🌐 Python | 📅 2026-09-03: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,897 | 🐛 71 | 🌐 HTML | 📅 2026-09-03: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,897 | 🐛 71 | 🌐 HTML | 📅 2026-09-03
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,769 | 🐛 242 | 🌐 Python | 📅 2026-09-03: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 391 | 🐛 58 | 🌐 Python | 📅 2026-09-03: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,105 | 🐛 552 | 🌐 Python | 📅 2026-09-03
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,308 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-03
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,048 | 🐛 21 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,921 | 🐛 265 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 859 | 🐛 12 | 🌐 Ruby | 📅 2026-09-03

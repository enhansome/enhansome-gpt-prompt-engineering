...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,448 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,448 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 76,060 | 🐛 299 | 🌐 Jupyter Notebook | 📅 2026-09-18: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 146,604 | 🐛 529 | 🌐 Python | 📅 2026-09-18: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 65,594 | 🐛 756 | 🌐 Python | 📅 2026-09-18: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,670 | 🐛 78 | 🌐 HTML | 📅 2026-09-09: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,670 | 🐛 78 | 🌐 HTML | 📅 2026-09-09
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,125 | 🐛 291 | 🌐 Python | 📅 2026-09-18: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 392 | 🐛 55 | 🌐 Python | 📅 2026-09-18: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,437 | 🐛 576 | 🌐 Python | 📅 2026-09-18
...
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,054 | 🐛 20 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,939 | 🐛 311 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 868 | 🐛 12 | 🌐 Ruby | 📅 2026-09-18

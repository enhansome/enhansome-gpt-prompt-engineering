...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,954 | 🐛 279 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,954 | 🐛 279 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,700 | 🐛 299 | 🌐 Jupyter Notebook | 📅 2026-09-01: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,445 | 🐛 446 | 🌐 Python | 📅 2026-09-01: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,527 | 🐛 716 | 🌐 Python | 📅 2026-09-01: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,425 | 🐛 71 | 🌐 HTML | 📅 2026-09-01: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,425 | 🐛 71 | 🌐 HTML | 📅 2026-09-01
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,730 | 🐛 234 | 🌐 Python | 📅 2026-09-01: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 391 | 🐛 58 | 🌐 Python | 📅 2026-09-01: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,061 | 🐛 534 | 🌐 Python | 📅 2026-09-01
...
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 858 | 🐛 12 | 🌐 Ruby | 📅 2026-09-01

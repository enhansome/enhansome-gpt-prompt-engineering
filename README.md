...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,086 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,086 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,833 | 🐛 285 | 🌐 Jupyter Notebook | 📅 2026-09-05: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,879 | 🐛 455 | 🌐 Python | 📅 2026-09-07: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,859 | 🐛 732 | 🌐 Python | 📅 2026-09-04: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,569 | 🐛 74 | 🌐 HTML | 📅 2026-09-06: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,569 | 🐛 74 | 🌐 HTML | 📅 2026-09-06
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,854 | 🐛 238 | 🌐 Python | 📅 2026-09-07: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 392 | 🐛 59 | 🌐 Python | 📅 2026-09-04: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,215 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,187 | 🐛 598 | 🌐 Python | 📅 2026-09-07
...
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,923 | 🐛 275 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 860 | 🐛 12 | 🌐 Ruby | 📅 2026-09-07

# Awesome GPT Prompt Engineering with stars
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,554 | 🐛 279 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,554 | 🐛 279 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,323 | 🐛 247 | 🌐 Jupyter Notebook | 📅 2026-08-18: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 144,487 | 🐛 406 | 🌐 Python | 📅 2026-08-18: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 63,535 | 🐛 689 | 🌐 Python | 📅 2026-08-18: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,440 | 🐛 65 | 🌐 HTML | 📅 2026-08-18: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,440 | 🐛 65 | 🌐 HTML | 📅 2026-08-18
* [Best Data Science ChatGPT Prompts](https://github.com/travistangvh/ChatGPT-Data-Science-Prompts) ⭐ 1,618 | 🐛 1 | 📅 2023-12-28
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,447 | 🐛 201 | 🌐 Python | 📅 2026-08-18: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 389 | 🐛 112 | 🌐 Python | 📅 2026-08-18: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,204 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,667 | 🐛 507 | 🌐 Python | 📅 2026-08-18
...
* [Plug-in example code in Python](https://github.com/ruvnet/chatgpt_plugin_python) ⭐ 97 | 🐛 1 | 🌐 Python | 📅 2023-03-23: Example code for creating a ChatGPT plug-in in Python.
* [Surfer Plug-in source code](https://github.com/ruvnet/Surfer) ⭐ 89 | 🐛 4 | 🌐 Python | 📅 2023-04-23
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,259 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-18
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,039 | 🐛 19 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,915 | 🐛 244 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 854 | 🐛 12 | 🌐 Ruby | 📅 2026-08-18
...
* [KennethanCeyer Awesome-llmops](https://github.com/KennethanCeyer/awesome-llmops) ⭐ 55 | 🐛 17 | 📅 2025-03-17
...
🚀 **RECOMMENDED**: [Use any LLM from the command line easily with llm](https://github.com/snwfdhmp/llm) ⭐ 59 | 🐛 2 | 🌐 JavaScript | 📅 2025-10-21. 🚀

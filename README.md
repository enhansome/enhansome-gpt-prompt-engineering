...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,104 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,104 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,853 | 🐛 284 | 🌐 Jupyter Notebook | 📅 2026-09-05: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,957 | 🐛 460 | 🌐 Python | 📅 2026-09-08: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,923 | 🐛 738 | 🌐 Python | 📅 2026-09-08: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,691 | 🐛 78 | 🌐 HTML | 📅 2026-09-06: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,691 | 🐛 78 | 🌐 HTML | 📅 2026-09-06
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,880 | 🐛 235 | 🌐 Python | 📅 2026-09-08: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,216 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,205 | 🐛 605 | 🌐 Python | 📅 2026-09-08
...
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,924 | 🐛 276 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 860 | 🐛 12 | 🌐 Ruby | 📅 2026-09-08

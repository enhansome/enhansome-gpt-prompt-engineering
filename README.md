...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,055 | 🐛 280 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,055 | 🐛 280 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,800 | 🐛 289 | 🌐 Jupyter Notebook | 📅 2026-09-05: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,797 | 🐛 451 | 🌐 Python | 📅 2026-09-06: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,786 | 🐛 732 | 🌐 Python | 📅 2026-09-04: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,494 | 🐛 74 | 🌐 HTML | 📅 2026-09-06: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,494 | 🐛 74 | 🌐 HTML | 📅 2026-09-06
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,832 | 🐛 265 | 🌐 Python | 📅 2026-09-06: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
...
* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,173 | 🐛 578 | 🌐 Python | 📅 2026-09-06
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,313 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-06
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,049 | 🐛 21 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,922 | 🐛 274 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 860 | 🐛 12 | 🌐 Ruby | 📅 2026-09-06

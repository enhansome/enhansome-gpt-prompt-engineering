...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,323 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,323 | 🐛 281 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,980 | 🐛 293 | 🌐 Jupyter Notebook | 📅 2026-09-14: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 146,323 | 🐛 491 | 🌐 Python | 📅 2026-09-14: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 65,283 | 🐛 749 | 🌐 Python | 📅 2026-09-14: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,336 | 🐛 78 | 🌐 HTML | 📅 2026-09-09: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,336 | 🐛 78 | 🌐 HTML | 📅 2026-09-09
* [Best Data Science ChatGPT Prompts](https://github.com/travistangvh/ChatGPT-Data-Science-Prompts) ⭐ 1,623 | 🐛 1 | 📅 2023-12-28
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,015 | 🐛 254 | 🌐 Python | 📅 2026-09-14: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 392 | 🐛 57 | 🌐 Python | 📅 2026-09-14: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,218 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,332 | 🐛 573 | 🌐 Python | 📅 2026-09-14
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,330 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-14
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,050 | 🐛 20 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,932 | 🐛 297 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 865 | 🐛 12 | 🌐 Ruby | 📅 2026-09-14

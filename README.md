...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,750 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,750 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,519 | 🐛 296 | 🌐 Jupyter Notebook | 📅 2026-08-24: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 144,894 | 🐛 419 | 🌐 Python | 📅 2026-08-24: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 63,948 | 🐛 683 | 🌐 Python | 📅 2026-08-24: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,847 | 🐛 69 | 🌐 HTML | 📅 2026-08-24: This repo includes ChatGPT prompt curation to use ChatGPT better. .
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,568 | 🐛 221 | 🌐 Python | 📅 2026-08-24: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 389 | 🐛 64 | 🌐 Python | 📅 2026-08-24: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,849 | 🐛 537 | 🌐 Python | 📅 2026-08-24
...
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,043 | 🐛 20 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,919 | 🐛 254 | 🌐 Shell | 📅 2026-05-21

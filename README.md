...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,019 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,019 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,746 | 🐛 292 | 🌐 Jupyter Notebook | 📅 2026-09-04: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,648 | 🐛 449 | 🌐 Python | 📅 2026-09-04: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,709 | 🐛 725 | 🌐 Python | 📅 2026-09-04: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,310 | 🐛 73 | 🌐 HTML | 📅 2026-09-04: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,310 | 🐛 73 | 🌐 HTML | 📅 2026-09-04
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,796 | 🐛 255 | 🌐 Python | 📅 2026-09-04: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,211 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,123 | 🐛 567 | 🌐 Python | 📅 2026-09-04
...
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,921 | 🐛 268 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 859 | 🐛 12 | 🌐 Ruby | 📅 2026-09-04

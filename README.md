...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,909 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: Guides, papers, lecture, notebooks and resources for prompt engineering.
* [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 77,909 | 🐛 278 | 🌐 MDX | 📅 2026-03-11: A GitHub repository that provides a prompt engineering guide with the latest papers and learning guides.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 75,624 | 🐛 296 | 🌐 Jupyter Notebook | 📅 2026-08-28: OpenAI's cookbook includes examples of prompt engineering.
...
* [LangChain Github Repository](https://github.com/hwchase17/langchain) ⭐ 145,291 | 🐛 430 | 🌐 Python | 📅 2026-08-30: Building applications with LLMs through composability.
* [Embedchain Github Repository](https://github.com/embedchain/embedchain) ⭐ 64,370 | 🐛 704 | 🌐 Python | 📅 2026-08-28: Framework to create ChatGPT-like bots over your dataset.
...
* [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,225 | 🐛 70 | 🌐 HTML | 📅 2026-08-30: This repo includes ChatGPT prompt curation to use ChatGPT better. .
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,225 | 🐛 70 | 🌐 HTML | 📅 2026-08-30
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,693 | 🐛 218 | 🌐 Python | 📅 2026-08-30: Evaluate, test, and ship LLM applications across your dev and production lifecycles.
* [Rhesis AI](https://github.com/rhesis-ai/rhesis) ⭐ 391 | 🐛 59 | 🌐 Python | 📅 2026-08-28: OSS Platform & SDK. Collaborative agent testing for teams.
...
* [LMQL](https://github.com/eth-sri/lmql) ⭐ 4,209 | 🐛 120 | 🌐 Python | 📅 2025-05-22: Query language for programming large language models.
* [OpenPromptStudio](https://moonvy.com/apps/ops/)
* [BossGPT](https://www.gptboss.com)

## Auto-GPT Related

* [Auto-GPT Official Repo](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 187,015 | 🐛 522 | 🌐 Python | 📅 2026-08-30
...
* [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) ⭐ 6,299 | 🐛 109 | 🌐 TypeScript | 📅 2026-08-30
* [EwingYangs Awesome-open-gpt](https://github.com/EwingYangs/awesome-open-gpt) ⭐ 6,044 | 🐛 21 | 🌐 Python | 📅 2025-05-16
* [tensorchord Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,921 | 🐛 260 | 🌐 Shell | 📅 2026-05-21
* [AiTreasureBox](https://github.com/superiorlu/AiTreasureBox) ⭐ 858 | 🐛 12 | 🌐 Ruby | 📅 2026-08-30
